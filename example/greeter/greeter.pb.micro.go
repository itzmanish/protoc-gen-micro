...
import (
	context "context"
	api "github.com/annwntech/go-micro/v2/api"
	client "github.com/annwntech/go-micro/v2/client"
	server "github.com/annwntech/go-micro/v2/server"
)
...
type GreeterService interface {
	Hello(ctx context.Context, req *Request, opts ...client.CallOption) (*Response, error)
	ClientStream(ctx context.Context, opts ...client.CallOption) (Greeter_ClientStreamService, error)
	ServerStream(ctx context.Context, req *Request, opts ...client.CallOption) (Greeter_ServerStreamService, error)
...
func (c *greeterService) Hello(ctx context.Context, req *Request, opts ...client.CallOption) (*Response, error) {
	rsp := &Response{}
	err := c.c.Call(ctx, c.c.NewRequest(c.name, "Greeter.Hello", req), rsp, opts...)
	if err != nil {
		return nil, err
	}
	return rsp, nil
...
func (c *greeterService) ClientStream(ctx context.Context, opts ...client.CallOption) (Greeter_ClientStreamService, error) {
	stream, err := c.c.Stream(ctx, c.c.NewRequest(c.name, "Greeter.ClientStream", &Request{}), opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greeterServiceClientStream) Close() error {
...
func (c *greeterService) ServerStream(ctx context.Context, req *Request, opts ...client.CallOption) (Greeter_ServerStreamService, error) {
	stream, err := c.c.Stream(ctx, c.c.NewRequest(c.name, "Greeter.ServerStream", &Request{}), opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterService) Stream(ctx context.Context, opts ...client.CallOption) (Greeter_StreamService, error) {
	stream, err := c.c.Stream(ctx, c.c.NewRequest(c.name, "Greeter.Stream", &Request{}), opts...)
	if err != nil {
		return nil, err
	}
...
func (h *greeterHandler) Hello(ctx context.Context, req *Request, rsp *Response) error {
	return h.GreeterHandler.Hello(ctx, req, rsp)
}
...
func (x *greeterClientStreamStream) Close() error {
	return x.stream.Close()
}
